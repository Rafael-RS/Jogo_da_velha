...
"""
    Modulo responsavel por desenhar a tela do jogo
"""
...
class Tela(object):
    ...
    def boas_vindas(self):
        ...
        self.stdscr.addstr(16,1, "Desenvolvido por RSR")
        self.stdscr.addstr(17,1, "Licença...")

    def ajuda(self):
        self.stdscr.clear()
        self.stdscr.border()
        self.stdscr.addstr()
        self.stdscr.addstr(1,1, "Pressione 'Q' para sair ou 'H' para obter ajuda")
        self.stdscr.addstr(2,1, "Para mudar a posição, digite umas das teclas: 'A', 'S', 'W', 'D'.")
        self.stdscr.addstr(3,1, "Para definir uma posição do jogo, aperte: 'Enter'")
        self.stdscr.addstr(3,1, "Para reiniciar a partida, aperte: 'Y'")
        self.stdscr.addstr(3,1, "Pressione 'Espaço' para sair desta tela.")
        self.stdscr.refresh()
